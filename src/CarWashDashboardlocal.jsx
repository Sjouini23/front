              ...
              <div className="space-y-4">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-3 md:space-y-0">
                  ...
                  <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                    <button
                      onClick={serviceData.exportToCSV}
                      className="px-4 py-2 rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold hover:from-green-600 hover:to-emerald-700 transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2 shadow-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500/50"
                    >
                      <Download size={14} />
                      <span>Export Luxury</span>
                    </button>
                    <button
                      onClick={() => serviceData.setShowServiceForm(true)}
                      className="px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-700 text-white font-bold hover:from-blue-600 hover:via-purple-700 hover:to-indigo-800 transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2 shadow-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                    >
                      <Plus size={14} />
